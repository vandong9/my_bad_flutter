...
EdgeInsets _dialogPadding = const EdgeInsets.symmetric(
  horizontal: AppFontSize.sizeSmallx,
  vertical: AppFontSize.sizeSmall,
);

Widget _progressWidget = Image.asset(
  'assets/gifs/double_ring_loading_io.gif',
);
    ...
    return _customBody ??
        Container(
          ...
          decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(AppFontSize
                  .sizeSmall) // use instead of BorderRadius.all(Radius.circular(20))
              ),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
